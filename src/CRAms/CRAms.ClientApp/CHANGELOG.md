...
- Create Angular project with ng: `ng new CRAms --package-manager=pnpm --prefix=crams --routing=true --skip-git=true --style=scss --zoneless=true`.
...
- Create project file (`crams.client.esproj`).
